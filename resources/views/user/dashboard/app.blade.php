  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('index') }}" class="nav-link">Back</a>
      </li>
    </ul>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="border-bottom:none">
      <div class="image">
       @if (auth()->user()->avatar_thumbnail)
            <img src="{{ auth()->user()->avatar_thumbnail }}" class="img-circle elevation-2" alt="User Image">
       @endif
      </div>
      <div class="info">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-header">Main Menu</li>
          ...
          <li class="nav-item">
            <a href="{{ route('profile.edit', auth()->id()) }}" class="nav-link">
...
<!-- ./wrapper -->
  ...
  <script src="{{ asset('js/all/fileupload.js') }}"></script>
