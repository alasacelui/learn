...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/ui/adminlte.min.css') }}">
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="border-bottom:none">
      <div class="image">
        <img src="  {{asset('/images/pm.png')}}" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="#" class="text-primary">Learn</a>.</strong>
    All rights reserved.
...
<!-- ./wrapper -->
  ...
  <script src="{{ asset('js/ui/adminlte.min.js') }}"></script>
  {{--FA--}}
